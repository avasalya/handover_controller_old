...
namespace mc_handover
{
	...
	:mc_control::fsm::Controller(robot_module, dt, config)
	{
		...
		selfCollisionConstraint.addCollisions(solver(), {
			...
			mc_rbdyn::Collision("RARM_LINK2", "BODY", 0.15, 0.10, 0.),
			mc_rbdyn::Collision("RARM_LINK3", "BODY", 0.15, 0.10, 0.),

			mc_rbdyn::Collision("LARM_LINK4", "BODY", 0.10, 0.05, 0.),
			mc_rbdyn::Collision("LARM_LINK5", "BODY", 0.10, 0.05, 0.),
