...
namespace mc_handover
{
	...
	void ApproachObject::initials()
	{
		...
		robotRtMarkers = {"wristRtEfA", "wristRtEfB", "gripperRtEfA", "gripperRtEfB", "dummy"};
		...
		strMarkersName.insert(strMarkersName.end(), robotRtMarkers.begin(), robotRtMarkers.end()-1);
